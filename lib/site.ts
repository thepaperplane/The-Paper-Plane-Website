...
export const SITE = {
  ...
  description:
    'Tax architecture, business incorporation, statutory audit and custom digital infrastructure — delivered as one integrated practice for founders and finance teams across India.',
